        ...
        <div className="relative w-full md:w-4/6 lg:w-3/6 xl:w-2/5 my-6 mx-auto h-full md:h-auto ">
          ...
          <div
            className={`transalte duration-300 h-full ${
              showModal ? "translate-y-0" : "transalte-y-full"
            } ${showModal ? "opacity-100" : "opacity-0"}`}
          >
            <div className="relative flex flex-col w-full h-full md:h-auto  border-0 rounded-lg shadow-lg bg-white outline-none focus:outline-none">
              {/* HEADER */}
